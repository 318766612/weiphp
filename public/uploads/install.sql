...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统行为表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '行为日志表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 268 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信插件表';
...
CREATE TABLE `wp_area`  (
  ...
  `sort` int(10) NULL DEFAULT 0 COMMENT '排序号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 659 CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '附件表';
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户组与分类的对应关系表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 422 CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
) ENGINE = InnoDB AUTO_INCREMENT = 78 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统配置表';
...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '插件钩子表';
...
CREATE TABLE `wp_lottery_games`  (
  ...
  `keyword` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '微信关键词',
  `game_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '游戏类型',
  `start_time` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` int(10) NULL DEFAULT NULL COMMENT '结束时间',
  `status` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '状态',
  ...
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  `manager_id` int(10) NULL DEFAULT NULL COMMENT '管理员id',
  `url` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '关注链接',
  `attend_num` int(10) NULL DEFAULT 0 COMMENT '参与总人数',
  `template` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '模板',
  `need_subscribe` tinyint(2) NULL DEFAULT 0 COMMENT '关注公众号才能参与',
  `need_member` tinyint(2) NULL DEFAULT NULL COMMENT '成为会员才能参与',
  ...
  `winning_mess_img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '中奖推送消息封面图片',
  `winning_mess_text` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中奖推送消息封面描述',
  `winning_money_text` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '抽中现金红包推送消息',
  `winning_score_text` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '抽中积分推送消息',
  `current_draw_num` int(10) NULL DEFAULT 0 COMMENT '当前抽奖次数',
  `draw_count` int(10) NULL DEFAULT 0 COMMENT '活动抽奖总次数',
  `win_num_list` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '抽中奖品对应次数列表',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_lottery_games_award_link`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `award_id` int(10) NULL DEFAULT NULL COMMENT '奖品id',
  `games_id` int(10) NULL DEFAULT NULL COMMENT '抽奖游戏id',
  `grade` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中奖等级',
  `num` int(10) NULL DEFAULT NULL COMMENT '奖品数量',
  `max_count` int(10) NULL DEFAULT NULL COMMENT '最多抽奖',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  `sort` int(10) NULL DEFAULT 0 COMMENT '排序',
...
CREATE TABLE `wp_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 804 CHARACTER SET = utf8 COLLATE = utf8_general_ci;
...
CREATE TABLE `wp_model`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `name`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1568 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统模型表' ROW_FORMAT = Dynamic;
...
INSERT INTO `wp_model` VALUES (1520, 'shop_card_member', '实体店会员卡', 0, '', 1, '[\"username\",\"phone\",\"sex\",\"birthday\",\"address\",\"ctime\",\"is_get\",\"token\",\"shop_code\",\"score\",\"card_number\"]', '1:基础', '', '', '', '', 'username:姓名\r\nphone:手机号\r\nsex:性别\r\nbirthday|time_format:生日\r\naddress:地址\r\nscore:导入积分\r\ncard_number:绑定会员卡号\r\nctime|time_format:导入时间\r\nis_get|get_name_by_status:是否领取\r\nid:操作:changeGet&id=[id]&is_get=[is_get]|改变领取状态', 10, 'username:请输入姓名', '', 1444362335, 1453951928, 1, 'MyISAM', 'shop');
INSERT INTO `wp_model` VALUES (1559, 'lottery_games', '抽奖游戏', 0, '', 1, '[\"title\",\"keyword\",\"game_type\",\"start_time\",\"end_time\",\"status\",\"day_attend_limit\",\"attend_limit\",\"day_win_limit\",\"win_limit\",\"day_winners_count\",\"remark\",\"cover\"]', '1:基础', '', '', '', '', 'id:序号\r\ntitle:活动名称\r\ngame_type|get_name_by_status:游戏类型\r\nkeyword:关键词\r\nstart_time|time_format:开始时间\r\nend_time|time_format:结束时间\r\nstatus:活动状态\r\nattend_num:参与人次\r\nwinners_list:中奖人列表\r\nids:操作:[EDIT]|编辑,[DELETE]|删除,preview&games_id=[id]|预览,draw/Wap/index&games_id=[id]|复制链接,statistics&games_id=[id]|统计分析', 10, 'title:请输入活动名称搜索', '', 1444877287, 1491375194, 1, 'MyISAM', 'draw');
INSERT INTO `wp_model` VALUES (1560, 'lottery_games_award_link', '抽奖游戏奖品设置', 0, '', 1, '[\"award_id\",\"games_id\",\"grade\",\"num\",\"max_count\"]', '1:基础', '', '', '', '', '', 10, '', '', 1444900969, 1491373787, 1, 'MyISAM', 'draw');
...
CREATE TABLE `wp_plugin`  (
  ...
  INDEX `name`(`name`) USING BTREE,
  INDEX `sti`(`status`, `is_show`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 130 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统插件表';
...
-- ----------------------------
-- Table structure for wp_shop_card_member
-- ----------------------------
DROP TABLE IF EXISTS `wp_shop_card_member`;
CREATE TABLE `wp_shop_card_member`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号',
  ...
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '导入时间',
  `is_get` tinyint(2) NULL DEFAULT 1 COMMENT '是否领取',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `shop_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址编码',
  `score` int(10) NULL DEFAULT NULL COMMENT '积分余额',
  `card_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员卡号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `wp_shop_order`  (
  ...
  `update_at` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新时间',
